...
| Patch disappears after a VS Code update | Updates overwrite `workbench.html` | The extension re-checks and re-applies on every startup; you can also run **Copilot RTL: Enable** manually |
